...
A direct, alternative proof that $|\cK|\leq 2m-1$ is given in the [Appendix](#sec-variant).
...
# Direct proof that $|\cK|\leq 2m-1$ {#sec-variant .appendix .unnumbered}
