...
The first confidence bounds are found in @MR2279468 and @MR2279639, although, in the latter, only for selection sets of the form $\{i\in\Nm : p_i\leq s\}$ where $p_i$ is the $p$-value associated to the null hypothesis $\Hoi$ and $s\in[0,1]$ is a threshold. In @MR2951390 the authors re-wrote the generic construction of @MR2279468 in terms of closed testing [@MR468056], proposed several practical constructions and sparked a new interest in multiple testing procedures based on confidence bounds This work was followed by a prolific series of works like @MR3305943 or @MR4731977. In @MR4124323, the authors introduce the new point of view of references families (see @sec-reference-fam) to construct post hoc bounds, and show the links between this meta-technique and the closed testing one, along with new bounds. 
