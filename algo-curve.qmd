...
In addition to the computation of all $\Vstar(S_t)$, @alg-formal-curve also computes partitions $\cP^t$ that realize the minimum in \eqref{eq_vstar_Qpartition} for $\Vstar(S_t)$.
