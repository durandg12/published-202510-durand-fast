...
\begin{tikzpicture}[scale=1]
 ...
 \node[quadri, draw=red] (P23) at (0, 0) {$P_{2:3}$\\$\zeta_{(2, 3)}=0$\\$\eta_{(2, 3)}^0=0$};
 \node[quadri] (P45) at (3, 0) {$P_{4:5}$\\$\zeta_{(4, 5)}=4$\\$\eta_{(4, 5)}^0=0$};
 \node[quadri] (P6) at (5, 3) {$P_6$\\$\zeta_{(6, 6)}=1$\\$\eta_{(6, 6)}^0=0$};
 \node[quadri, draw=red] (P7) at (8, 3) {$P_7$\\$\zeta_{(7, 7)}=0$\\$\eta_{(7, 7)}^0=0$};
 %
...
\begin{tikzpicture}[scale=1]
 ...
 \node[quadri, draw=red] (P23) at (0, 0) {$P_{2:3}$\\$\zeta_{(2, 3)}=0$\\$\eta_{(2, 3)}^1=0$};
 \node[quadri] (P45) at (3, 0) {$P_{4:5}$\\$\zeta_{(4, 5)}=4$\\$\eta_{(4, 5)}^1=1$};
 \node[quadri] (P6) at (5, 3) {$P_6$\\$\zeta_{(6, 6)}=1$\\$\eta_{(6, 6)}^1=0$};
 \node[quadri, draw=red] (P7) at (8, 3) {$P_7$\\$\zeta_{(7, 7)}=0$\\$\eta_{(7, 7)}^1=0$};
 %
...
\begin{tikzpicture}[scale=1]
 ...
 \node[quadri, draw=red] (P23) at (0, 0) {$P_{2:3}$\\$\zeta_{(2, 3)}=0$\\$\eta_{(2, 3)}^2=0$};
 \node[quadri] (P45) at (3, 0) {$P_{4:5}$\\$\zeta_{(4, 5)}=4$\\$\eta_{(4, 5)}^2=2$};
 \node[quadri] (P6) at (5, 3) {$P_6$\\$\zeta_{(6, 6)}=1$\\$\eta_{(6, 6)}^2=0$};
 \node[quadri, draw=red] (P7) at (8, 3) {$P_7$\\$\zeta_{(7, 7)}=0$\\$\eta_{(7, 7)}^2=0$};
 %
...
\begin{tikzpicture}[scale=1]
 ...
 \node[quadri, draw=red] (P23) at (0, 0) {$P_{2:3}$\\$\zeta_{(2, 3)}=0$\\$\eta_{(2, 3)}^5=0$};
 \node[quadri, draw=red] (P45) at (3, 0) {$P_{4:5}$\\$\zeta_{(4, 5)}=4$\\$\eta_{(4, 5)}^5=4$};
 \node[quadri] (P6) at (5, 3) {$P_6$\\$\zeta_{(6, 6)}=1$\\$\eta_{(6, 6)}^5=0$};
 \node[quadri, draw=red] (P7) at (8, 3) {$P_7$\\$\zeta_{(7, 7)}=0$\\$\eta_{(7, 7)}^5=0$};
 %
...
\begin{tikzpicture}[scale=1]
 ...
 \node[quadri] (P8) at (11, 3) {$P_8$\\$\zeta_{(8, 8)}=3$\\$\eta_{(8, 8)}^6=1$};
 %
 \node[quadri] (P1) at (-3, 0) {$P_1$\\$\zeta_{(1, 1)}=2$\\$\eta_{(1, 1)}^6=0$};
 \node[quadri, draw=red] (P23) at (0, 0) {$P_{2:3}$\\$\zeta_{(2, 3)}=0$\\$\eta_{(2, 3)}^6=0$};
 \node[quadri, draw=red] (P45) at (3, 0) {$P_{4:5}$\\$\zeta_{(4, 5)}=4$\\$\eta_{(4, 5)}^6=4$};
 \node[quadri] (P6) at (5, 3) {$P_6$\\$\zeta_{(6, 6)}=1$\\$\eta_{(6, 6)}^6=0$};
 \node[quadri, draw=red] (P7) at (8, 3) {$P_7$\\$\zeta_{(7, 7)}=0$\\$\eta_{(7, 7)}^6=0$};
 %
