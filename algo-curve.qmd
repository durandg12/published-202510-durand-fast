...
Mathematically speaking, a confidence upper bound (also frequently named post hoc bound, post selection bound or confidence envelope) is a function $\Vhat : \cP(\Nm^*) \to \Nm$, where $\Nm=\{0,\dotsc,m\}$, $\Nm^*=\{1,\dotsc,m\}$ and $m$ is the number of hypotheses, such that 
\begin{equation}
